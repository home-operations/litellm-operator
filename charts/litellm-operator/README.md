...
| controller.health.port | int | `8081` | Health/readiness probe port. |
...
| controller.metrics.enabled | bool | `false` | Expose the controller-runtime metrics endpoint. |
| controller.metrics.port | int | `8443` | Metrics port. |
| controller.metrics.secure | bool | `true` | Serve metrics over HTTPS with authn/authz. |
